...
const BookItemDetails = () => {
  ...
  return (
    <>
      <Navbar />
     <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-200 py-12 px-6 font-sans">
  {/* Book Details Card */}
  <div className="flex flex-col md:flex-row items-center md:items-start p-10 rounded-2xl shadow-2xl bg-white w-full max-w-5xl mx-auto mt-10">
    {/* Book Image */}
    ...
    <div className="flex-1 text-center md:text-left">
      <h1 className="text-4xl font-extrabold text-gray-900 mb-3 leading-snug">
        {bookDetails.title}
      </h1>
      <h2 className="text-xl text-gray-600 mb-5 italic">by {bookDetails.author}</h2>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-start md:space-x-3 mb-3">
        ...
        <span className="text-blue-600 font-semibold">{bookDetails.status}</span>
      </div>
  ...
  <div className="p-10 rounded-2xl shadow-2xl bg-white w-full max-w-5xl mx-auto mt-8">
